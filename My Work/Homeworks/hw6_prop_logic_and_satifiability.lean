...
-- I had to look at the answer key.
/-
...
1. Add new binary connective, xorOp -- done
2. Add pXor as shorthand for binOpExp xorOp -- done
3. Add ⊕ as an infix notation for pXor -- done
4. Specify the interpretation of ⊕ to be bxor -- done
5. Extend interpBinOp to handle the new case -- done
...
--#reduce pEval binOpExp pTrue tt
/-
...
def X : pExp := varExp (mkVar 0) -- the streets are wet
